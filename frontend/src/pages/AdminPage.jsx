...
import { CreateBrand, CreateType, DeleteBrand, DeleteType } from '../http/adminApi'
    ...
    <Container fluid='lg'>
            ...
            <Form>
                ...
                <Form.Group className='mb-3 d-flex-column' style={{height: 300}}  >
                    ...
                    <Form.Control type='file' placeholder='Item Image' value={itemImage} onChange={(e) => setItemImage(e.target.value)} />
                    <Button variant='outline-primary' className='mt-2'>Add</Button>
                </Form.Group>
            </Form>
            </Row>
            <Row>
